...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{figures/fict_fspec.png}
\caption{Specific thrust variation with compressor pressure ratio and turbine inlet temperature for the fictional turbojet at Mach 3.2.}
\label{fig:fspec_map}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{figures/fict_tsfc.png}
\caption{TSFC variation for physically feasible operating points of the fictional turbojet at Mach 3.2.}
\label{fig:tsfc_map}
\end{figure}